...
class ExportVertex:
	__slots__ = ("hash", "vertexIndex", "faceIndex", "position", "normal", "color", "texcoord0", "texcoord1", "tangent", "bitangent")
...
class OpenGexExporter(bpy.types.Operator, ExportHelper):
	...
	def DeindexMesh(mesh, materialTable):
		...
		exportVertexArray = []
		faceIndex = 0
		mesh.calc_tangents(mesh.tessface_uv_textures[0].name)
		...
		for face in mesh.tessfaces:
			...
			exportVertex.tangent = tan1.tangent
			exportVertex.bitangent = tan1.bitangent
			...
			exportVertex.tangent = tan2.tangent
			exportVertex.bitangent = tan2.bitangent
			exportVertexArray.append(exportVertex)
			...
			exportVertex.tangent = tan3.tangent
			exportVertex.bitangent = tan3.bitangent
			exportVertexArray.append(exportVertex)
